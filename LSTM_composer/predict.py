...
def generate():
    ...
    with open('D:/program/python/Lib/mylib/LSTM_composer/LSTM_composer/data/notes', 'rb') as filepath:
...
def create_network(network_input, n_vocab):
    ...
    model.load_weights(
        'D:/program/python/Lib/mylib/LSTM_composer/LSTM_composer/weights.hdf5')
